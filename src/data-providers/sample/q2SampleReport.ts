...
import type { HistoricalMarketPeriod, IndustrialMarketReport, LeaseRecord, PropertyHighlight, SaleRecord, SubmarketMetrics } from '../../report-engine/schema/industrialMarketReport';
...
].map(([name,inventorySf,deliveredSf,underConstructionSf,speculativeShare,netAbsorptionSf,vacancyRate,availabilityRate,askingNetRentPsf,salesVolume]) => ({name,inventorySf,deliveredSf,underConstructionSf,speculativeShare,netAbsorptionSf,vacancyRate,availabilityRate,askingNetRentPsf,salesVolume} as SubmarketMetrics));
...
export const q2Leases: LeaseRecord[] = [
  {tenant:'Hyundai Translead',sizeSf:906517,address:'3835 Youngs Rd, Channahon, IL 60410',leaseType:'Direct / New'},
  {tenant:'Kehe Distributors',sizeSf:802440,address:'1850 S Cherry Hill Rd, Joliet, IL 60432',leaseType:'Direct / New'},
  {tenant:'Distribution 2000',sizeSf:453568,address:'1120-1140 Remington Blvd, Romeoville, IL 60446',leaseType:'Direct / New'},
];

export const q2Sales: SaleRecord[] = [
  {buyer:'Realty Income Corporation',price:124000000,address:'23301 S Central Ave, University Park, IL 60484',saleType:'Investment'},
  {buyer:'Realty Income Corporation',price:102745301,address:'3101 Protection Pky, Glenview, IL 60062',saleType:'Investment'},
  {buyer:'Realty Income Corporation',price:73711746,address:'2501 Sanders Rd, Glenview, IL 60062',saleType:'Investment'},
];
...
export const q2SampleReport: IndustrialMarketReport = {
  report: { id:'chicago-industrial-2026-q2', title:'Industrial Market Report', templateId:'industrial-market-report', period:'2026 Q2', market:'Overall Market', preparedBy:'Lee & Associates of Illinois' },
  ...
  provenance: [
    {fieldPath:'overallMarket.vacancyRate',selectedValue:calculatedTotals.vacancyRate,sources:[{sourceId:'submarket-stats-q2',sourceType:'excel',value:calculatedTotals.vacancyRate,reference:'Submarket Table B2:B19 (inventory-weighted)'},{sourceId:'market-indicators-q2',sourceType:'excel',value:.0484,reference:'Market Indicators workbook'},{sourceId:'approved-q2-pdf',sourceType:'pdf',value:.0496,reference:'Page 3, Market Indicators'}],authority:'Calculated submarket workbook total',status:'reconciled',note:'The approved PDF rounds the calculated total to 4.96%; the indicator workbook contains 4.84%.'},
    {fieldPath:'overallMarket.availabilityRate',selectedValue:calculatedTotals.availabilityRate,sources:[{sourceId:'submarket-stats-q2',sourceType:'excel',value:calculatedTotals.availabilityRate,reference:'Submarket Table B2:B19 (inventory-weighted)'},{sourceId:'market-indicators-q2',sourceType:'excel',value:.0846,reference:'Market Indicators workbook'},{sourceId:'approved-q2-pdf',sourceType:'pdf',value:.0853,reference:'Page 3, Market Indicators'}],authority:'Calculated submarket workbook total',status:'reconciled',note:'The approved PDF rounds the calculated total to 8.53%; the indicator workbook contains 8.46%.'},
    {fieldPath:'overallMarket.underConstructionSf',selectedValue:calculatedTotals.underConstructionSf,sources:[{sourceId:'submarket-stats-q2',sourceType:'excel',value:calculatedTotals.underConstructionSf,reference:'Submarket Table D2:D19'},{sourceId:'market-indicators-q2',sourceType:'excel',value:13779195,reference:'Market Indicators workbook'},{sourceId:'approved-q2-pdf',sourceType:'pdf',value:13912547,reference:'Pages 2-3'}],authority:'Submarket Stats workbook',status:'reconciled',note:'The submarket sum is used on pages 2 and 3.'},
    {fieldPath:'submarkets.Southeast Wisconsin.netAbsorptionSf',selectedValue:891612,sources:[{sourceId:'submarket-stats-q2',sourceType:'excel',value:891612,reference:'Submarket Table F17'},{sourceId:'approved-q2-pdf',sourceType:'pdf',value:891615,reference:'Page 2, Southeast Wisconsin row'}],authority:'Submarket Stats workbook',status:'override',note:'The approved visible row differs by 3 SF; totals continue to use the workbook value.'},
  ],
  presentationOverrides: [
    {fieldPath:'submarkets.Southeast Wisconsin.netAbsorptionSf',value:891615,source:'approved-q2-pdf',reason:'Preserve the approved visible Page 2 value while retaining 891,612 in the normalized data.'},
  ],
};
